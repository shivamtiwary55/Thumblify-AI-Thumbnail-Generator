    ...
    <>
      ...
      <div className="min-h-screen flex items-center justify-center p-4">
        <form
          ...
          className="w-full sm:w-96 text-center bg-white/10 border border-white/10 rounded-2xl px-8 backdrop-blur-md"
        >
          ...
          <p className="text-gray-400 text-sm mt-2">
            {state === "login" ? "Please sign in to continue" : "Create an account"}
          </p>
