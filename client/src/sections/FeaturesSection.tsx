    ...
    return (
        <div id="features" className="px-4 md:px-16 lg:px-24 xl:px-32">
            ...
            <div className="mt-40 relative mx-auto max-w-5xl">
                ...
                >
                    Experience the future of thumbnail creation with our AI-powered generator. Save time, boost engagement, and elevate your content with stunning, click-worthy thumbnails crafted just for you.
                </motion.p>
